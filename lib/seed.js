...
export const SEED = {
   ...
   * fresh record would read as a real holding. Votes have their own total here
   * because nothing else on the record knows how many of them exist.
   */
  shareholders: { voterShares: 0, voters: [] },
...
export async function ensureData() {
  ...
  if (data && data.company) {
    ...
    if (!data.shareholders) {
      data.shareholders = { voterShares: 0, voters: [] };
    }
